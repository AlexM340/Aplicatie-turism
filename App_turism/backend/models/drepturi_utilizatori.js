...
const Drepturi_utilizatori = sequelize.define('drepturi_utilizatori', {
    id: {
...
Drepturi_utilizatori.sync()
  ...
  .catch((error) => console.error('Eroare la sincronizarea tabelului drepturi_utilizatori:', error));
